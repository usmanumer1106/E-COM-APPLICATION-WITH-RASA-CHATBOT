<?php
function view_banner($con)
{

	$sql = "select * from banner where status='1' order by id asc";
...
function sentInvoice($con,$order_id){
	...
	$mail->SMTPSecure="tls";
	$mail->SMTPAuth=true;
	$mail->Username="soulhacker6678@gmail.com";
	$mail->Password="usman106";
	$mail->SetFrom("soulhacker6678@gmail.com");
