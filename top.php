...
$meta_title="THESTORE.COM";
$meta_desc="THESTORE.COM";
$meta_keyword="THESTORE.COM";
$site_path="http://localhost/ecom/";

if($mypage=='product.php'){
	$product_id=get_safe_value($con,$_GET['id']);
	$product_meta=mysqli_fetch_assoc(mysqli_query($con,"select * from product where id='$product_id'"));
	$meta_title=$product_meta['name'];
	$meta_image=$site_path.$product_meta['image'];
	$meta_desc=$product_meta['name'];
	$meta_keyword=$product_meta['name'];
	$url=$site_path."product.php?id=".$product_id;
