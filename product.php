                                ...
                                <div class="product__big__images">
                                    <div class="portfolio-full-image tab-content">
                                        <div role="tabpanel" class="tab-pane fade in active imageZoom" id="img-tab-1">
                                            <img  width="" data-origin="<?php echo $get_product['0']['image'] ?>" src="<?php echo $get_product['0']['image'] ?>">
                                        </div>

										<?php if (isset($multipleImages[0])) {?>
										<div id="multiple_images">
									<?php	echo "<img src='" . $get_product['0']['image'] . "' onclick=showMultipleImage('" . $get_product['0']['image'] . "')>";
    foreach ($multipleImages as $list) {
        echo "<img src='" . $list . "' onclick=showMultipleImage('" . $list . "')>";
    }
    ?>
...
if ($cart_show != '') {
    ?>
								...
								<div id="social_share_box">
									<a href="https://facebook.com/share.php?u=<?php echo $url ?>"><img src='images/icons/facebook.png'/></a>
									<a href="https://twitter.com/share?text=<?php echo $get_product['0']['name'] ?>&url=<?php echo $url ?>"><img src='images/icons/twitter.png'/></a>
									<a href="https://api.whatsapp.com/send?text=<?php echo $get_product['0']['name'] ?> <?php echo $url ?>"><img src='images/icons/whatsapp.png'/></a>
								</div>
                            </div>
									   ...
									   <div class="col-md-12">
										  <form action="" method="post">
											 ...
											 <div class="text-right mt10">
												<button class="btn btn-success btn-lg rounded-0" type="submit" name="review_submit" style="background-color:#c43b68;">Submit</button>
											 </div>
										  </form>
									   </div>
									</div>
...
if (isset($_COOKIE['recently_viewed'])) {
    ...
    if ($countStartRecentView > 4) {
		...
		$arrRecentView = array_slice($arrRecentView, -4, 4);
									...
									<div class="category">
												<div class="ht__cat__thumb">
													<a href="product.php?id=<?php echo $list['id'] ?>">
														<img src="<?php echo $list['image'] ?>" alt="product images">
													</a>
												</div>
